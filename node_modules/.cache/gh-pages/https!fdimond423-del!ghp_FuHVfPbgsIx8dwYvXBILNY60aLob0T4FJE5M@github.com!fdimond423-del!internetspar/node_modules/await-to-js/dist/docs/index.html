...
<head>
	...
	<title>await-to-js | await-to-js</title>
		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="index.html">await-to-js</a></strong>
				</div>
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<h1 id="await-to-js">await-to-js</h1>
			<p><a href="https://npmjs.org/package/await-to-js"><img src="https://img.shields.io/npm/v/await-to-js.svg?style=flat-square" alt="NPM version"></a>
			<a href="https://npmjs.org/package/await-to-js"><img src="http://img.shields.io/npm/dm/await-to-js.svg?style=flat-square" alt="Downloads"></a></p>
			<blockquote>
				<p>Async await wrapper for easy error handling</p>
			</blockquote>
			<h2 id="pre-requisites">Pre-requisites</h2>
			<p>You need to use Node 7.6 (or later) or an ES7 transpiler in order to use async/await functionality.
			You can use babel or typescript for that.</p>
			<h2 id="install">Install</h2>
			<pre><code class="lang-sh">npm i await-to-js --save
</code></pre>
			<h2 id="usage">Usage</h2>
			<pre><code class="lang-js"><span class="hljs-keyword">import</span> to <span class="hljs-keyword">from</span> <span class="hljs-string">'await-to-js'</span>;
<span class="hljs-comment">// If you use CommonJS (i.e NodeJS environment), it should be:</span>
<span class="hljs-comment">// const to = require('await-to-js').default;</span>

<span class="hljs-keyword">async</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">asyncTaskWithCb</span>(<span class="hljs-params">cb</span>) </span>{
     <span class="hljs-keyword">let</span> err, user, savedTask, notification;
    ...
    <span class="hljs-keyword">if</span>(user.notificationsEnabled) {
       [ err ] = <span class="hljs-keyword">await</span> to(NotificationService.sendNotification(user.id, <span class="hljs-string">'Task Created'</span>));
    ...
    <span class="hljs-keyword">if</span>(savedTask.assignedUser.id !== user.id) {
       [ err, notification ] = <span class="hljs-keyword">await</span> to(NotificationService.sendNotification(savedTask.assignedUser.id, <span class="hljs-string">'Task was created for you'</span>));
       <span class="hljs-keyword">if</span>(err) <span class="hljs-keyword">return</span> cb(<span class="hljs-string">'Error while sending notification'</span>);
    }
...
<span class="hljs-keyword">async</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">asyncFunctionWithThrow</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">const</span> [err, user] = <span class="hljs-keyword">await</span> to(UserModel.findById(<span class="hljs-number">1</span>));
  <span class="hljs-keyword">if</span> (!user) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">'User not found'</span>);
			...
			<pre><code class="lang-javascript">interface ServerResponse {
  <span class="hljs-attr">test</span>: number;
}

<span class="hljs-keyword">const</span> p = <span class="hljs-built_in">Promise</span>.resolve({<span class="hljs-attr">test</span>: <span class="hljs-number">123</span>});

<span class="hljs-keyword">const</span> [err, data] = <span class="hljs-keyword">await</span> to&lt;ServerResponse&gt;(p);
<span class="hljs-built_in">console</span>.log(data.test);
</code></pre>
			<h2 id="license">License</h2>
			<p>MIT © <a href="http://blog.grossman.io">Dima Grossman</a> &amp;&amp; Tomer Barnea</p>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-external-module"><a href="modules/_await_to_js_.html" class="tsd-kind-icon">"await-<wbr>to-<wbr>js"</a></li>
						</ul>
					</section>
				</div>
			</section>
